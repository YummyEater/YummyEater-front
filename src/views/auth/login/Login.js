...
import { ContentHeader, GoogleLogin } from '../../../components'
...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    signin({ email: email, password: password }, navigate, state || '/');
  }
    ...
    <div className='w-[700px] max-[700px]:max-w-[700px] max-[700px]:w-screen container1 px-[25px]'>
      ...
      <div className='flex flex-col justify-center items-center'>
        <form className='flex flex-col justify-center items-center max-w-[550px] w-full'
          ...
          <div className={inputwrap + ' pt-[15px]'}>
      ...
      <div className='pt-[75px]' id='oauth-login'>
        ...
        <div className='pt-[30px] flex justify-center'><GoogleLogin back={state} /></div>
      </div>
    </div>
  )
}
